...
exe=$HOME/software/gromacs-4.6.7+/bin
...
$exe/mdrun_467mpi -s $pwd/prep/vchmod${node}_${type}.tpr  -rerun $1 -g ${1}_$node.log -e ${1}_$node -o ${1}_$node  1>/dev/null 2>/dev/null 
...
$exe/mdrun_467mpi -s $pwd/prep/vchmod${node2}_${type}.tpr -rerun $1 -g ${1}_$node2.log -e ${1}_$node2 -o ${1}_$node2  1>/dev/null 2>/dev/null
